...
class AdaIN(nn.Module):
    def __init__(self, in_channel, style_dim, spatial):
        ...
        #self.conditioned_blend = nn.Linear(style_dim, in_channel)
        #self.conditioned_blend.weight.data.fill_(0)
        #self.conditioned_blend.bias.data.fill_(0)
        self.channelwise_alpha = nn.Parameter(torch.zeros(in_channel,spatial,spatial))
    ...
    def forward(self, input, style):
        ...
        out = out * self.channelwise_alpha + input * (1 - self.channelwise_alpha)
        return out
...
class Generator(nn.Module):
    def __init__(
        ...
        ## AdaIN Layers
        self.adain1 = AdaIN(512,512,64)
        self.adain2 = AdaIN(256,512,128)
        self.adain3 = AdaIN(128,512,256)
